describe('comments tests', () => {
  ...
  it('Edit Buy Now', function() {
    ...
    /* ==== End Cypress Studio ==== */
    /* ==== Generated with Cypress Studio ==== */
    cy.get(':nth-child(9) > #chakra-toast-manager-bottom > .chakra-toast > .chakra-toast__inner > #toast-1 > .css-njbp03 > #toast-1-title').click();
    cy.get(':nth-child(9) > #chakra-toast-manager-bottom > .chakra-toast > .chakra-toast__inner > #toast-1 > .css-1pq15d > .chakra-icon').click();
    /* ==== End Cypress Studio ==== */
  });
